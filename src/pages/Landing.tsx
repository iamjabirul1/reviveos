          ...
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            >
              {[
                ...
                {
                  name: 'Growth',
                  desc: 'For growing teams who want consistent weekly meetings from dormant pipeline.',
                ...
                {
                  name: 'Scale',
                  desc: 'For agencies and operators managing multiple brands or clients.',
